...
⚠️ **版权警告：本项目仅供个人自用，不得公开分发**  

本仓库包含使用《空洞骑士：丝之歌》（Hollow Knight: Silksong）游戏录屏和录音制作的文件。请注意：  

1. 这些录屏和录音仍属于 **Team Cherry** 的版权作品。  
2. 本项目 **不受 Team Cherry 官方许可用于公开分发或商业用途**。  
3. **仅限个人自用**：在自己的电脑上使用、测试或学习。  
4. **禁止上传、开源发布或分发**本模组及其素材到 GitHub、Steam Workshop、Reddit、论坛或其他公共平台。  
5. 如果您希望公开分享，请使用自己的原创素材或遵循官方允许的授权方式。  

使用本项目即表示您已理解并同意以上版权限制。团队不对因违反版权规定而产生的任何后果负责。
